    ...
    public WeeklyRotatorsMapping(){
        Mapping = new Dictionary<string, List<long>>{
            ...
            { "Spire of the Watcher", new List<long> 
                {
                    4174431791,3138208275,2306182339,8293111,2479144625,2599025960,2599025960,1480429241,3088058655,119121067,506181038,2976233114,918537443,597199405,2839517205,3006077984,2014814167,
